...
\end{compactitem}
    ...
    \begin{minipage}{0.45\textwidth}\begin{center}\vfill\begin{adjustbox}{max size={!}{0.175\textheight}}\includegraphics[width=\textwidth]{platinum1}\end{adjustbox}\vfill\end{center}\end{minipage}
        ...
        \hspace{2em}\begin{minipage}{0.45\textwidth}\begin{center}\vfill\begin{adjustbox}{max size={!}{0.175\textheight}}\includegraphics[width=\textwidth]{ti_better}\end{adjustbox}\vfill\end{center}\end{minipage}
        \\
            \end{center}
