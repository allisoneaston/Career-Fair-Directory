...
Sincerely, \begin{multicols}{2}
	\begin{minipage}{\columnwidth}
			\includegraphics{Sig1}\\
			Mike Boyd\\
			TBP Career Fair Director\\
			\end{minipage}
\begin{minipage}{\columnwidth}
			\includegraphics{Sig2}\\
			Emily Carroll\\
			SWE Career Fair Director\\
			\end{minipage}
\begin{minipage}{\columnwidth}
			\includegraphics{Sig3}\\
			Natalie Eyke\\
			TBP Career Fair Director\\
			\end{minipage}
\begin{minipage}{\columnwidth}
			\includegraphics{Sig4}\\
			Christie Rockwell\\
			SWE Career Fair Director\\
			\end{minipage}
