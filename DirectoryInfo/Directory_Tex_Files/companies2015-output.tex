\documentclass[twoside]{article}
    ...
    \begin{minipage}{\columnwidth}
            \includegraphics[height=0.6in, width=2in,keepaspectratio]{BC}\\
            Becca Cohn\\
            SWE Career Fair Director\\
            \end{minipage}
\begin{minipage}{\columnwidth}
            \includegraphics[height=0.6in, width=2in,keepaspectratio]{JDM}\\
            Jon McCormick\\
            TBP Career Fair Director\\
            \end{minipage}
\begin{minipage}{\columnwidth}
            \includegraphics[height=0.6in, width=2in,keepaspectratio]{LS}\\
            Lance Schmidt\\
            TBP Career Fair Director\\
            \end{minipage}
\begin{minipage}{\columnwidth}
            \includegraphics[height=0.6in, width=2in,keepaspectratio]{MW}\\
            Meredith Wood\\
            SWE Career Fair Director\\
            \end{minipage}
...
\end{minipage}
    \end{multicols}\newpage{\fontspec{Bookman Old Style} \fontsize{20}{24}\selectfont \bf Message from Corporate Sponsor\\Fidessa}\\~\\{\fontsize{12.000000}{12.000000}\selectfont Hey UMich Engineering students: \\[-0.250000ex]~ \\[-0.250000ex]~ We are Fidessa, an innovative tech company with a passion for delivering high performance solutions to the finance industry. We're looking for driven, passionate, and diverse engineering students like you to help us make an impact and create cutting edge applications used across the world. We know that the University of Michigan Engineering students are just that and that's why Fidessa is a proud sponsor of the 2015 SWE/TBP Engineering Career Fair!\\[-0.250000ex]~ \\[-0.250000ex]~ We are a dynamic global company with over 15 offices worldwide. With continued commitment from our employees and customers, we offer unique access to the largest and most valuable trading community, from global institutions and investment banks to boutique brokers and niche hedge funds. Our advanced products and services cover the whole trading lifecycle, from low latency trading tools to settlement, compliance and risk management.\\[-0.250000ex]~ \\[-0.250000ex]~ We are freethinking and do not believe in rigid structure or tight controls where these limit our ability to be innovative and adaptable. We recognize that a business is only as good as its people. To provide and build on our high-quality platform and services, we seek to employ only the best!\\[-0.250000ex]~ \\[-0.250000ex]~ Do you think you have what it takes? If so, stop by the Fidessa booth at the Engineering Career Fair to speak with a Fidessa representative and take our Coding challenge. \\[-0.250000ex]~ \\[-0.250000ex]~ We look forward to seeing you there! \\[-0.250000ex]~ \\[-0.250000ex]~ Learn more about Fidessa at \url{www.fidessa.com/careers} \\[-0.250000ex]~ \\[-0.250000ex]~ Sincerely, \\[-0.250000ex]~ \\[-0.250000ex]~ Fidessa Recruitment Team \\[-0.250000ex]~}\begin{center}\begin{adjustbox}{max size={.5\textwidth}{2in}}\includegraphics[height=2in]{Fidessa_LOGO}\end{adjustbox}\end{center}\newpage{\fontspec{Bookman Old Style} \fontsize{20}{24}\selectfont \bf Message from Corporate Sponsor\\BP}\\~\\{\fontsize{12.000000}{12.000000}\selectfont Dear University of Michigan Engineering Students:\\[-0.250000ex]~ \\[-0.250000ex]~ On behalf of our partnership with the Society of Women Engineers and Tau Beta Pi, BP America is pleased to welcome you to the 2015 SWE/TBP Engineering Career Fair! \\[-0.250000ex]~ \\[-0.250000ex]~ FULL-TIME, INTERNSHIP \& CO-OP OPPORTUNITIES FOR ENGINEERING RELATED MAJORS\\[-0.250000ex]~ \\[-0.250000ex]~ Here at BP, you will have opportunities to develop in many areas. From becoming a world-class engineering specialist to pursuing a career in project management or operations; you will experience a journey of consistent growth and development. Full-time hires at BP will be a part of the Challenge program. This is a program that provides experience of the complete exploration process through a series of 18-24 month placements. You’ll discover the complex, interrelated nature of energy as you work on real projects with real applications and real responsibilities. Everyone will go through a thorough training and development program where you’ll have a structured induction, access to a buddy and mentor, training, managed job rotations, site/field exposure, networking and planned development. With each role, there is a distinct training program.\\[-0.250000ex]~ \\[-0.250000ex]~ At BP, we are equally committed to our internship programs. As an intern or co-op you’ll work on real projects that deliver tangible benefits and measurable results. At the same time, you’ll have the opportunity to learn about and help to solve some of the most important issues we face. You will experience genuine teamwork, and work alongside highly qualified and experienced colleagues, while you work on live projects and operations, using the latest equipment and technology.\\[-0.250000ex]~ \\[-0.250000ex]~ Depending on your major and area of interest for your career, individuals with engineering related majors may have the opportunity to work within one or more of the following segments in BP: Upstream, Downstream, and Alternative Energy.\\[-0.250000ex]~ \\[-0.250000ex]~ BP recruits majors for the following disciplines: Engineering, Science and Business. Candidates with a minimum 3.2 GPA pursuing bachelor’s, master’s and PhD degrees are encouraged to apply for roles of their interest. All applicants are required to apply online at \url{www.bp.com/uscampus} for interview consideration. \\[-0.250000ex]~ \\[-0.250000ex]~ We at BP stand for SAFETY, EXCELLENCE, RESPECT, COURAGE and ONE TEAM. Stop our booth our booth today to learn of more of the exciting opportunities that await you at BP. Join us! \\[-0.250000ex]~ \\[-0.250000ex]~ Sincerely,\\[-0.250000ex]~ The University of Michigan Recruiting Team\\[-0.250000ex]~}\begin{center}\begin{adjustbox}{max size={.5\textwidth}{2in}}\includegraphics[height=2in]{BP_LOGO.jpg}\end{adjustbox}\end{center}\newpage{\fontspec{Bookman Old Style} \fontsize{20}{24}\selectfont \bf Message from Corporate Sponsor\\UP}\\~\\{\fontsize{12.000000}{12.000000}\selectfont Lorem ipsum\\[-0.250000ex]~}\begin{center}\begin{adjustbox}{max size={.5\textwidth}{2in}}\includegraphics[height=2in]{UP_LOGO.jpg}\end{adjustbox}\end{center}\newpage\input{../Directory_Tex_Files/MapAndShit.tex}\startcompanysection
    \fancyhead[C]{ {\fontspec{Bookman Old Style} \fontsize{40}{48}\selectfont \bf\color{white}Career Fair 2015}\\[12pt]
    {\fontspec{Monotype Corsiva}\fontsize{36}{41}\selectfont \color{white}\em Monday, September 28}\\
    }
...
\begin{minipage}{\columnwidth}\begin{tabularx}{.95\columnwidth}{Xr}
                 {\Large\bf DRW Trading Group} & {\Large\bf FXB}\\
    \multicolumn{2}{p{.95\columnwidth}}{\url{https://careers-drw.icims.com/jobs/intro?hashed=-435741505&mobile=false&width=940&height=500&bga=true&needsRedirect=false&jan1offset=-360&jun1offset=-300}}\\
    \multicolumn{2}{p{.95\columnwidth}}{\emph{Majors:} FE, MSE, DS, ISD, CEE, MFE, BME, CIVIL, ROB, AOSS, IP, IOE, CLASP, CHE, EE, AUTO, NERS, AERO, CE, ESE, ENT, ENV, CS, EP, ME, NAME, APhys, PHARM, EE:S}\\
    \multicolumn{2}{p{.95\columnwidth}}{\emph{Positions:} Full-time, Internship}\\
    \multicolumn{2}{p{.95\columnwidth}}{\emph{Degrees:} }\\
    \multicolumn{2}{p{.95\columnwidth}}{\emph{Hiring Policy:} 2}\\
...
\begin{minipage}{\columnwidth}\begin{tabularx}{.95\columnwidth}{Xr}
                 {\Large\bf Eaton Corporation} & {\Large\bf GGB}\\
    \multicolumn{2}{p{.95\columnwidth}}{\url{750}}\\
    \multicolumn{2}{p{.95\columnwidth}}{\emph{Majors:} ME, EE, AERO, CE, CS, IOE, MSE}\\
    \multicolumn{2}{p{.95\columnwidth}}{\emph{Positions:} Full-time, Internship, Co-op}\\
    \multicolumn{2}{p{.95\columnwidth}}{\emph{Degrees:} Bachelor's}\\
    \multicolumn{2}{p{.95\columnwidth}}{\emph{Hiring Policy:} 3}\\
    \end{tabularx}
...
\end{compactitem}
    ...
    \startsponsorsection\fancyhead[C]{ {\fontspec{Bookman Old Style} \fontsize{40}{48}\selectfont \bf\color{white}Career Fair 2015}\\[12pt]
    {\fontspec{Monotype Corsiva}\fontsize{36}{41}\selectfont \color{white}\em Tuesday, September 29}\\
    \begin{tikzpicture}[remember picture,overlay]
    \node[yshift=-\headheight-10pt] at (current page.north)
    {\fontsize{16}{18}\selectfont \bf Sponsors};
    \end{tikzpicture}
...
\begin{minipage}{.9\columnwidth}\begin{tabularx}{.95\columnwidth}{Xr}
    ...
    \multicolumn{2}{p{.95\columnwidth}}{\url{http://chj.tbe.taleo.net/chj04/ats/careers/searchResults.jsp?org=FEV&cws=1&org=FEV}}\\
    \multicolumn{2}{p{.95\columnwidth}}{\emph{Majors:} FE, MSE, DS, ISD, CEE, MFE, BME, CIVIL, ROB, AOSS, IP, IOE, CLASP, CHE, EE, AUTO, NERS, AERO, CE, ESE, ENT, ENV, CS, EP, ME, NAME, APhys, PHARM, EE:S}\\
    \multicolumn{2}{p{.95\columnwidth}}{\emph{Positions:} Full-time, Internship}\\
    \multicolumn{2}{p{.95\columnwidth}}{\emph{Degrees:} Bachelor's,Master's}\\
    \multicolumn{2}{p{.95\columnwidth}}{\emph{Hiring Policy:} 2}\\
...
\end{compactitem}
    ...
    \begin{adjustbox}{max size={0.65\textwidth}{!}}\includegraphics[height=0.128571428571\textheight]{diamond1.jpg}\end{adjustbox}\vspace{1em}\\
        \begin{adjustbox}{max size={0.65\textwidth}{!}}\includegraphics[height=0.128571428571\textheight]{diamond2.jpg}\end{adjustbox}\vspace{1em}\\
        \begin{adjustbox}{max size={0.65\textwidth}{!}}\includegraphics[height=0.128571428571\textheight]{diamond3.eps}\end{adjustbox}\vspace{1em}\\
        \begin{adjustbox}{max size={0.65\textwidth}{!}}\includegraphics[height=0.128571428571\textheight]{diamond4.eps}\end{adjustbox}\vspace{1em}\\
        \begin{adjustbox}{max size={0.65\textwidth}{!}}\includegraphics[height=0.128571428571\textheight]{diamond5.eps}\end{adjustbox}\vspace{1em}\\
        \begin{adjustbox}{max size={0.65\textwidth}{!}}\includegraphics[height=0.128571428571\textheight]{diamond6.jpg}\end{adjustbox}\vspace{1em}\\
        \begin{adjustbox}{max size={0.65\textwidth}{!}}\includegraphics[height=0.128571428571\textheight]{diamond7.eps}\end{adjustbox}\vspace{1em}\\
        \end{center}
    \newpage
    ...
    \begin{minipage}{0.45\textwidth}\begin{center}\vfill\begin{adjustbox}{max size={!}{0.116666666667\textheight}}\includegraphics[width=\textwidth]{platinum1.eps}\end{adjustbox}\vfill\end{center}\end{minipage}
        \hspace{2em}\begin{minipage}{0.45\textwidth}\begin{center}\vfill\begin{adjustbox}{max size={!}{0.116666666667\textheight}}\includegraphics[width=\textwidth]{platinum2.png}\end{adjustbox}\vfill\end{center}\end{minipage}
        \\
            \begin{minipage}{0.45\textwidth}\begin{center}\vfill\begin{adjustbox}{max size={!}{0.116666666667\textheight}}\includegraphics[width=\textwidth]{platinum3.pdf}\end{adjustbox}\vfill\end{center}\end{minipage}
        \hspace{2em}\begin{minipage}{0.45\textwidth}\begin{center}\vfill\begin{adjustbox}{max size={!}{0.116666666667\textheight}}\includegraphics[width=\textwidth]{platinum4.ps}\end{adjustbox}\vfill\end{center}\end{minipage}
        \\
            \begin{minipage}{0.45\textwidth}\begin{center}\vfill\begin{adjustbox}{max size={!}{0.116666666667\textheight}}\includegraphics[width=\textwidth]{platinum5.png}\end{adjustbox}\vfill\end{center}\end{minipage}
        \hspace{2em}\begin{minipage}{0.45\textwidth}\begin{center}\vfill\begin{adjustbox}{max size={!}{0.116666666667\textheight}}\includegraphics[width=\textwidth]{platinum6.ps}\end{adjustbox}\vfill\end{center}\end{minipage}
        \\
            \begin{minipage}{0.45\textwidth}\begin{center}\vfill\begin{adjustbox}{max size={!}{0.116666666667\textheight}}\includegraphics[width=\textwidth]{platinum7.jpg}\end{adjustbox}\vfill\end{center}\end{minipage}
        \hspace{2em}\begin{minipage}{0.45\textwidth}\begin{center}\vfill\begin{adjustbox}{max size={!}{0.116666666667\textheight}}\includegraphics[width=\textwidth]{platinum8.pdf}\end{adjustbox}\vfill\end{center}\end{minipage}
        \\
            \begin{minipage}{0.45\textwidth}\begin{center}\vfill\begin{adjustbox}{max size={!}{0.116666666667\textheight}}\includegraphics[width=\textwidth]{platinum9.jpg}\end{adjustbox}\vfill\end{center}\end{minipage}
        \\
            \end{center}
    {\fontspec{Bookman Old Style} \fontsize{16}{19}\selectfont \bf Thank You to Our Gold Corporate Sponsors!}
    \vspace{0em}\begin{center}
    \begin{minipage}{0.3\textwidth}\begin{center}\includegraphics[max height=0.075\textheight, max width=\textwidth]{gold1.eps}\vfill\end{center}\end{minipage}
        \hspace{1em}\begin{minipage}{0.3\textwidth}\begin{center}\includegraphics[max height=0.075\textheight, max width=\textwidth]{gold2.png}\vfill\end{center}\end{minipage}
        \hspace{1em}\begin{minipage}{0.3\textwidth}\begin{center}\includegraphics[max height=0.075\textheight, max width=\textwidth]{gold3.jpg}\vfill\end{center}\end{minipage}
        \\
            \begin{minipage}{0.3\textwidth}\begin{center}\includegraphics[max height=0.075\textheight, max width=\textwidth]{gold4.eps}\vfill\end{center}\end{minipage}
        \hspace{1em}\begin{minipage}{0.3\textwidth}\begin{center}\includegraphics[max height=0.075\textheight, max width=\textwidth]{gold5.jpg}\vfill\end{center}\end{minipage}
        \hspace{1em}\begin{minipage}{0.3\textwidth}\begin{center}\includegraphics[max height=0.075\textheight, max width=\textwidth]{gold6.jpg}\vfill\end{center}\end{minipage}
        \\
            \begin{minipage}{0.3\textwidth}\begin{center}\includegraphics[max height=0.075\textheight, max width=\textwidth]{gold7.jpg}\vfill\end{center}\end{minipage}
        \hspace{1em}\begin{minipage}{0.3\textwidth}\begin{center}\includegraphics[max height=0.075\textheight, max width=\textwidth]{gold8.eps}\vfill\end{center}\end{minipage}
        \hspace{1em}\begin{minipage}{0.3\textwidth}\begin{center}\includegraphics[max height=0.075\textheight, max width=\textwidth]{gold9.eps}\vfill\end{center}\end{minipage}
        \\
            \begin{minipage}{0.3\textwidth}\begin{center}\includegraphics[max height=0.075\textheight, max width=\textwidth]{gold10.eps}\vfill\end{center}\end{minipage}
        \hspace{1em}\begin{minipage}{0.3\textwidth}\begin{center}\includegraphics[max height=0.075\textheight, max width=\textwidth]{gold11.pdf}\vfill\end{center}\end{minipage}
        \hspace{1em}\begin{minipage}{0.3\textwidth}\begin{center}\includegraphics[max height=0.075\textheight, max width=\textwidth]{gold12.png}\vfill\end{center}\end{minipage}
        \\
            \begin{minipage}{0.3\textwidth}\begin{center}\includegraphics[max height=0.075\textheight, max width=\textwidth]{gold13.eps}\vfill\end{center}\end{minipage}
        \\
            \end{center}
    \newpage
    \backcover
    ...
    \begin{center}
    \vfill
    \includegraphics[height=0.2\textheight,max width=.85\textwidth]{Fidessa_LOGO}\\[3em]
        \includegraphics[height=0.2\textheight,max width=.85\textwidth]{BP_LOGO.jpg}\\[3em]
        \includegraphics[height=0.2\textheight,max width=.85\textwidth]{UP_LOGO.jpg}\\[3em]
        \vfill
